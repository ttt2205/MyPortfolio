const experiences = [
  ...
  },
  {
    ...
    description:
      "Engaged in comprehensive software engineering coursework, mastering core programming concepts, data structures, algorithms, and software design principles. Developed multiple projects using Java and Python, demonstrating proficiency in object-oriented programming and problem-solving skills. Collaborated on team projects to build web applications and APIs, gaining practical experience in version control and agile methodologies.",
    technologies: [
      "Java",
      "Spring Boot",
      "Python",
    ...
    <section id="experience" className="py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mb-16">
          ...
          >
            A timeline of my professional journey, from a curious beginner to my
